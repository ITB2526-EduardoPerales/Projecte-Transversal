...
- [1.Infraestructura del Centro de Procesamiento de Datos (CPD)](#1infraestructura-del-centro-de-procesamiento-de-datos-cpd)
  - [1.1 Diseño Arquitectónico y Ubicación Física](#11-diseno-arquitectonico-y-ubicacion-fisica)
    - [1.	Ubicación de la Sala y Justificación](#1-ubicacion-de-la-sala-y-justificacion)
    - [2.Medidas de Ocultación de la Infraestructura](#2medidas-de-ocultacion-de-la-infraestructura)
    - [3.	Sistema de Climatización, Rangos Ambientales y Calidad del Aire](#3-sistema-de-climatizacion-rangos-ambientales-y-calidad-del-aire)
    - [4.	Especificaciones del Suelo y Techo Técnico](#4-especificaciones-del-suelo-y-techo-tecnico)
    - [5.	Planos de Planta y Distribución de la Sala](#5-planos-de-planta-y-distribucion-de-la-sala)
  - [1.2 Infraestructura IT y Distribución de Racks](#12-infraestructura-it-y-distribucion-de-racks)
    - [1. Inventario de Hardware Físico (Servidores, Switches y Patch Panels)](#1-inventario-de-hardware-fisico-servidores-switches-y-patch-panels)
    - [2. Distribución Espacial de los Racks (Estructuración)](#2-distribucion-espacial-de-los-racks-estructuracion)
    - [3. Gestión del Cableado Estructurado](#3-gestion-del-cableado-estructurado)
    - [4. Diagramas de Alzado de los Racks](#4-diagramas-de-alzado-de-los-racks)
  - [1.3 Infraestructura Eléctrica y Continuidad de Negocio](#13-infraestructura-electrica-y-continuidad-de-negocio)
    - [1. Diseño de la Alimentación Redundante](#1-diseno-de-la-alimentacion-redundante)
    - [2. Cálculo de la Carga en Vatios (W) y Voltiamperios (VA)](#2-calculo-de-la-carga-en-vatios-w-y-voltiamperios-va)
    - [3. Dimensionamiento del Sistema de Alimentación Ininterrumpida (SAI)](#3-dimensionamiento-del-sistema-de-alimentacion-ininterrumpida-sai)
    - [4. Justificación del Tiempo de Autonomía de las Baterías](#4-justificacion-del-tiempo-de-autonomia-de-las-baterias)
  - [1.4 Seguridad y Prevención de Riesgos Laborales](#14-seguridad-y-prevencion-de-riesgos-laborales)
    - [1. Seguridad Física](#1-seguridad-fisica)
    - [2. Seguridad Lógica](#2-seguridad-logica)
    - [3. Medidas de prevención de riesgos laborales](#3-medidas-de-prevencion-de-riesgos-laborales)
  - [2. Despliegue de la Infraestructura Lógica en la Nube (AWS)](#2-despliegue-de-la-infraestructura-logica-en-la-nube-aws)
    - [2.1 Arquitectura de Red Virtual (VPC) y Seguridad Lógica](#21-arquitectura-de-red-virtual-vpc-y-seguridad-logica)
    - [2.2 Implementación de Servicios en Instancias EC2](#22-implementacion-de-servicios-en-instancias-ec2)
    - [2.3 Automatización, Accesos y Gestión de Configuración](#23-automatizacion-accesos-y-gestion-de-configuracion)
  - [3. Implantación de Servicios Multimedia y Redes](#3-implantacion-de-servicios-multimedia-y-redes)
    - [hala3.1. Servicio de Distribución de Audio Streaming](#hala31-servicio-de-distribucion-de-audio-streaming)
    - [3.2. Servicio de Vídeo Streaming y Videoconferencia](#32-servicio-de-video-streaming-y-videoconferencia)
    - [3.3. Pruebas Transversales de Rendimiento y Ancho de Banda](#33-pruebas-transversales-de-rendimiento-y-ancho-de-banda)
- [4. Diseño y Administración de la Base de Datos](#4-diseno-y-administracion-de-la-base-de-datos)
  - [4.1 Diseño de la base de datos](#41-diseno-de-la-base-de-datos)
    - [1. Diseño diagrama Entidad-Relación](#1-diseno-diagrama-entidad-relacion)
    - [2. Diseño del modelo relacional](#2-diseno-del-modelo-relacional)
  - [4.2 Implementación de la base de datos](#42-implementacion-de-la-base-de-datos)
    - [1. Elección del SGBD](#1-eleccion-del-sgbd)
    - [2. Instalación del SGBD y creación  de la BBDD](#2-instalacion-del-sgbd-y-creacion-de-la-bbdd)
  - [4.3 Gestión de usuarios, roles y permisos](#43-gestion-de-usuarios-roles-y-permisos)
    - [1. Definición de roles](#1-definicion-de-roles)
    - [2. Script para automatizar la creación de usuarios](#2-script-para-automatizar-la-creacion-de-usuarios)
  - [4.4 Triggers para control de accesos y Auditoría](#44-triggers-para-control-de-accesos-y-auditoria)
    - [1. Control de cuotas de los usuarios](#1-control-de-cuotas-de-los-usuarios)
    - [2. Tabla de avisos y auditoría](#2-tabla-de-avisos-y-auditoria)
    - [3. Gestión de bloqueo de usuarios](#3-gestion-de-bloqueo-de-usuarios)
  - [4.5 Eventos periódicos - Backup](#45-eventos-periodicos-backup)
  - [4.6 Creación de un playbook](#46-creacion-de-un-playbook)
- [5. Sostenibilidad, Gestión del Cambio y Transformación Digital](#5-sostenibilidad-gestion-del-cambio-y-transformacion-digital)
  - [5.1. Evaluación del Impacto de Seguridad e Importancia de los Datos](#51-evaluacion-del-impacto-de-seguridad-e-importancia-de-los-datos)
    - [1. Informe de Evaluación de Riesgos y Seguridad Física/Lógica](#1-informe-de-evaluacion-de-riesgos-y-seguridad-fisica-logica)
    - [2. Valor Estratégico de los Datos en la Economía Digital y Normativa Internacional](#2-valor-estrategico-de-los-datos-en-la-economia-digital-y-normativa-internacional)
  - [5.2. Optimización Tecnológica y Transformación Digital](#52-optimizacion-tecnologica-y-transformacion-digital)
    - [1. Medidas de Optimización de Recursos e Impacto Ambiental de la Infraestructura](#1-medidas-de-optimizacion-de-recursos-e-impacto-ambiental-de-la-infraestructura)
    - [2. Análisis de Transformación Digital: Alineación con los Objetivos Corporativos de Innovate Tech](#2-analisis-de-transformacion-digital-alineacion-con-los-objetivos-corporativos-de-innovate-tech)
- [6. Entregables Multimedia e Incidencias](#6-entregables-multimedia-e-incidencias)
    - [6.1. Enlace al Vídeo Demostrativo Oficial (3 Minutos)](#61-enlace-al-video-demostrativo-oficial-3-minutos)
    - [6.2. Registro de Incidencias, Problemas Encontrados y Soluciones Aplicadas.](#62-registro-de-incidencias-problemas-encontrados-y-soluciones-aplicadas)
...
### 1.	Ubicación de la Sala y Justificación
...
### 2.Medidas de Ocultación de la Infraestructura
...
### 3.	Sistema de Climatización, Rangos Ambientales y Calidad del Aire
...
### 4.	Especificaciones del Suelo y Techo Técnico
...
### 5.	Planos de Planta y Distribución de la Sala
...
### 1. Inventario de Hardware Físico (Servidores, Switches y Patch Panels)
...
### 3. Gestión del Cableado Estructurado
...
### 4. Diagramas de Alzado de los Racks
...
### 1. Diseño de la Alimentación Redundante
...
### 2. Cálculo de la Carga en Vatios (W) y Voltiamperios (VA)
...
### 3. Dimensionamiento del Sistema de Alimentación Ininterrumpida (SAI)
...
### 4. Justificación del Tiempo de Autonomía de las Baterías
...
## 2. Despliegue de la Infraestructura Lógica en la Nube (AWS)
...
#### 1. Diseño de Subredes, Tablas de Enrutamiento e Internet Gateway

Cómo trabajamos sobre la infraestructura preconfigurada de AWS, el entorno ya cuenta con un Internet Gateway y Tablas de Enrutamiento por defecto, los cuales se encargan de desviar de forma transparente todo el tráfico externo hacia internet y gestionar las peticiones que llegan a nuestras IPs públicas.

Para organizar los servicios del proyecto, combinamos el uso de direccionamiento privado (para la comunicación interna y segura entre servidores) y direccionamiento público (para que los usuarios puedan acceder a los servicios web, de vídeo, audio y bases de datos).

| Servidor / Instancia | Función del Servicio | IP Privada (Interna) | IP Pública (Externa) |
| --- | --- | --- | --- |
| VM-01 | Servidor Web Principal + SFTP | 172.31.3.13 | 3.212.184.9 |
| VM-02 | Servidor de Autenticación OpenLDAP | 172.31.16.232 | 32.196.203.72 |
| VM-03 | Servidor de Logs Centralizado | 172.31.24.230 | 52.7.181.195 |
...
- **¿Para qué sirve?** Nos garantiza que las IPs públicas de la tabla anterior nunca van a cambiar.
- **Impacto real: **Esto es vital para trabajar en equipo. Al dejar las IPs fijas, enlaces como el del streaming de vídeo (http://44.223.148.123/hls/index.m3u8), la base de datos o el audio son permanentes.

#### 2. Configuración de Firewalls Lógicos (Security Groups)

En cuanto a los security groups hemos abierto los puertos de entrada solo para los servicios los cuales lo usan y son necesarios, de esta manera también es más seguro.

VM-01 → Servidor Web Principal + SFTP
...
VM-02 → Servidor de Autenticación OpenLDAP
...
VM-03 → Servidor de Logs Centralizado
...
VM-04 → Servidor de Base de Datos
...
VM-06 → Servidor de Streaming de Vídeo
...
VM-07 → Servidor de Videoconferencias (JITSI MEET)
...
#### 1. Servidor Web y Servicio SFTP Seguro (Autenticación AD)

Para nuestro servidor web con sftp desplegamos una máquina con el siguiente hardware virtual:

**AMI** → Ubuntu Server 24.04 LTS por su estabilidad, soporte de larga duración y tiene una amplia compatibilidad.

**Tipo de instancia** → t3.medium ya que dispone de dos CPUs virtuales, 4 GiB de memoria RAM y hasta 5 GiB/s en red. 

**Almacenamiento** → 30 GiB de disco duro virtual con EBS, es espacio suficiente para nuestros servicios y hay posibilidad de escalabilidad.

Instalamos el servicio de NGINX y creamos el archivo de configuración de nuestra web en /etc/nginx/sites-available. Para nuestra web usaremos varias extensiones
...
Estos son los módulos que hemos instalado para el correcto funcionamiento de nuestra web.
...
Este es el archivo de configuración de nuestra web. Para activarla creamos el link simbólico. La reproducción de los servicios funcionan a la configuración de proxy inverso.
...
El contenido de nuestra web tiene esta estructura. Tenemos el portal web por donde se puede acceder a los servicios de streaming de audio y video de manera pública que sería el index.html. Aparte, tenemos el directorio admin con diferentes paǵinas. Este directorio pertenece al panel de administración interna de la empresa, que solo es accesible mediante credenciales de usuario de LDAP. Dentro del panel se puede acceder a los datos de la base de datos de la compañía.
...
Para configurar SFTP debemos tener el servidor de OpenSSH.
...
Dentro del archivo /etc/ssh/sshd_config debemos tener las líneas siguientes descomentadas para poder autenticarse con contraseña.
...
Hemos instalado los paquetes de SSSD y PAM para LDAP. SSSD permitirá que nuestro sistema utilice usuarios provenientes del árbol de directorio activo indicado. Aquí vemos la configuración para poder usarlo, donde indicamos el socket del servidor LDAP.
...
Debemos ejecutar el siguiente comando para que se aplique la autenticación con PAM y permita crear directorios home a los usuarios que se autentiquen por primera vez.
...
También editamos el archivo nsswitch.conf. Este es el que indica al sistema donde buscar cada uno de los objetos. Las importantes son las tres primeras lineas, pues son los usuarios, los grupos y las contraseñas de usuarios. Indicamos sss para que busque estos objetos en diretorios activos remotos, además de en los archivos locales.
...
Probamos los usuarios del directorio activo y vemos que funcionan.
...
Primeramente comenzamos con la instalación de Elasticsearch y Kibana, en el servidor VM-03 SRV LOG:
...
Podemos ver los logins realizados en cada servidor
...
A continuación se puede observar el código

---

- name: Despliegue Automático de OpenLDAP para Innovate Tech
  ...
  tasks:
    ...
    - name: 1. Actualizar repositorios e instalar OpenLDAP
    ...
    - name: 2. Crear directorio temporal para los archivos LDIF
    ...
    - name: 3. Generar archivo de estructura base (OUs) corregido

      copy:

        dest: /tmp/ldap/estructura.ldif

        content: |

          dn: ou=Usuarios,dc=innovatetech,dc=local

          objectClass: organizationalUnit

          ou: Usuarios

          dn: ou=Grupos,dc=innovatetech,dc=local

          objectClass: organizationalUnit

          ou: Grupos

    - name: 4. Cargar Unidades Organizativas en el LDAP

      shell: |

        ldapadd -x -D "{{ ldap_root_dn }}" -w "{{ ldap_admin_pass }}" -f /tmp/ldap/estructura.ldif

      register: ldap_ou_result

      failed_when: "ldap_ou_result.rc != 0 and 'Already exists' not in ldap_ou_result.stderr"

    - name: 5. Generar archivo LDIF con los 4 usuarios

      copy:

        dest: /tmp/ldap/usuarios_itb.ldif

        content: |

          dn: cn=eduardo,ou=Usuarios,dc=innovatetech,dc=local
          ...
          dn: cn=pol,ou=Usuarios,dc=innovatetech,dc=local
          ...
          dn: cn=lucia,ou=Usuarios,dc=innovatetech,dc=local
          ...
          dn: cn=aleshka,ou=Usuarios,dc=innovatetech,dc=local
          ...
          homeDirectory: /home/aleshka

          loginShell: /bin/bash

    - name: 6. Insertar usuarios en el directorio activo

      shell: |

        ldapadd -x -D "{{ ldap_root_dn }}" -w "{{ ldap_admin_pass }}" -f /tmp/ldap/usuarios_itb.ldif

      register: ldap_user_result

      failed_when: "ldap_user_result.rc != 0 and 'Already exists' not in ldap_user_result.stderr"

    - name: 7. Establecer contraseña @ITB2026 para todos los usuarios

      shell: |

        ldappasswd -x -D "{{ ldap_root_dn }}" -w "{{ ldap_admin_pass }}" -s "@ITB2026" "cn={{ item }},ou=Usuarios,dc=innovatetech,dc=local"
    ...
    - name: 8. Limpiar archivos temporales
...
Comprobación de que el playbook de ansible para instalar y configurar OpenLDAP funciona correctamente.
...
Tenemos el playbook para instalar y configurar el servicio de audio

---

- name: Configuració servidor d'àudio InnovateTech
  ...
  vars:
    ...
    icecast_relay_password: "ITB2026."

    icecast_admin_password: "ITB2026."

    icecast_hostname: "{{ ansible_default_ipv4.address }}"

    icecast_port: 8000

    music_dir: "/etc/icecast2/music"

    liquidsoap_script: "/etc/liquidsoap/radio.liq"

  tasks:

    - name: Actualitzar llista de paquets

      apt:

        update_cache: yes

    - name: Instal·lar Icecast2
    ...
    - name: Crear directori de música
    ...
    - name: Crear script de Liquidsoap

      template:

        src: radio.liq.j2

        dest: "{{ liquidsoap_script }}"

        mode: '0644'

      notify: Reiniciar Liquidsoap

    - name: Crear servei systemd de Liquidsoap
    ...
    - name: Habilitar i arrancar Liquidsoap
...
Para esto también necesitamos tres archivos templates.

El primero es para la configuración del Icecast2
...
El siguiente sería la configuración del servicio de liquidsoap con systemd

[Unit]

Description=Liquidsoap streaming client
...
ExecStart=/usr/bin/liquidsoap {{ liquidsoap_script }}
...
Y el último son los parámetros del canal de audio.

music = playlist(mode="randomize", reload=10, "{{ music_dir }}")
...
Usamos la clave privada de aws para poder conectarnos a las máquinas. 

- **Llave Privada (labsuser.pem):** Es el archivo secreto que tenemos que usar en cada dispositivo desde el que queremos conectarnos. Funciona como nuestra llave física para poder abrir la conexión a AWS.
- **Llave Pública:** Está metida dentro del servidor y actúa como el candado. Si nuestra llave **labsuser.pem** encaja con ese candado, entramos directos sin escribir contraseñas.

#### Gestión de Usuarios

Por seguridad, el usuario root está totalmente deshabilitado para evitar sustos o accesos no autorizados. Cada uno de nosotros tiene su propio usuario personalizado para administrar el sistema y saber quién hace qué:
...
Ninguno de estos usuarios tiene permisos de administrador de forma nativa. Cuando necesitamos hacer algo delicado (como instalar paquetes o reiniciar Nginx), usamos el comando sudo para ganar esos permisos en ese momento exacto.

## **3. Implantación de Servicios Multimedia y Redes**

### hala**3.1. Servicio de Distribución de Audio Streaming**
...
En este caso el servicio funciona gracias a dos componentes principales: la fuente de audio que será Liquidsoap y el servidor de distribución que será Icecast2.

Liquidsoap es el encargado de leer los ficheros de audio y codificarlos correctamente para que Icecast2 sea capaz de leerlos y distribuirlos a los clientes con HTTP.

#### 3.1.2. Guía de Instalación y Configuración del Servidor de Audio

Para nuestro servidor de audio desplegamos la máquina virtual VM-05. Esta dispondrá del siguiente hardware virtual:

**AMI** → Ubuntu Server 24.04 LTS por su estabilidad, soporte de larga duración y compatibilidad.

**Tipo de instancia** → t3.small con 2 CPUs virtuales y 2 GiB de memoria RAM. También tiene hasta 5 GiB/s para red, perfecto para una buena distribución del audio y aguante de carga de trabajo.

**Almacenamiento** → Un volumen de 20 GiB con EBS es suficiente para albergar nuestros servicios, con posibilidad de escalar en caso de necesitar más espacio.
...
En el fichero de config de icecast configuramos la identificación del servidor y permitimos un número de 100 clientes para dar servicio
...
Aquí definimos las credenciales para las fuentes de audio. Nuestra fuente es Liquidsoap y deberá usar esta contraseña para poder enviar el audio.
...
También definimos el hostname o IP y el puerto en que escucha.
...
El header definido permite que se embeba nuestro audio en webs con etiquetas HTML5 para multimedia. Esto permite crear nuestro portal web.

También definimos el mountpoint donde creamos nuestro canal de audio.
...
El formato de audio digital usado es principalmente el MP3. Esto es debido a varias razones:

MP3 es el formato de audio digital más usado, puesto que es compatible con cualquier dispositivo, sistema operativo, navegador web y demás herramientas sin necesidad de instalar programas adicionales.

En cuanto a la eficiencia de compresión, MP3 utiliza compresión con pérdida basada en la capacidad acústica humana, eliminando datos sonoros que el oído humano no percibe. Además, ofrece una calidad suficiente a 128kbps, haciendo un consumo de ancho de banda predecible y moderado.

Esta compatibilidad y eficiencia lo hace una opción mejor y más accesible que alternativas como OGG, que no es tan compatible con dispositivos antiguos, o AAC, puesto que requiere licncias. 
...
Prueba 1 - Velocidad en el servidor de audio VM - 05

probamos la velocidad en el servidor de audio mientras un cliente está reproduciendo contenido
...
Prueba 2 - Velocidad en el servidor web
...
![Imagen](./imagenes/img_111.png)



Ahora vamos a agregar mas videos y organizarlos por carpetas



![Imagen](./imagenes/img_112.png)





![Imagen](./imagenes/img_113.png)



Este será el lugar donde apunta cada video, irán con su respectiva carpeta



![Imagen](./imagenes/img_114.png)
...
http://44.223.148.123/hls/ciber/index.m3u8 

http://44.223.148.123/hls/docker/index.m3u8 
...
![Imagen](./imagenes/img_136.png)



#### 3.2.5. Análisis del Protocolo WebRTC y Evidencias de Videollamada Real

Aquí podemos visualizar que las videollamadas funcionan correctamente junto con el análisis del protocolo



![Imagen](./imagenes/img_137.png)





![Imagen](./imagenes/img_138.png)
...
#### 3.3.5. Integración automática del registro de medidas de ancho de banda

Para esto hacemos un script que se conecte con la base de datos y poder ejecutar el script desde otra máquina.

Aquí especificamos la información de nuestra base de datos y la información del usuario para que se establezca la conexión.



![Imagen](./imagenes/img_140.png)
...
En la base de datos hemos creado una tabla para los registros del ancho de banda: analisis_ancho_banda

![Imagen](./imagenes/img_141.png)



Luego ejecutamos el script para comprobar que funciona



![Imagen](./imagenes/img_142.png)
...
El model Entitat-Relació s'ha dissenyat amb l'objectiu de representar l'estructura organitzativa d'InnovateTech.



![Imagen](./imagenes/img_144.png)



#### Justificación de las entidades creadas

**Departamentos **

Se ha creado esta entidad para representar las áreas internas de la empresa. Cada empleado pertenece a un departamento concreto, por lo que era necesario representarlo para mantener una estructura jerárquica clara.

**Empleados**

Almacena los datos personales y profesionales de cada trabajador. Muchos procesos del sistema dependen directamente de los empleados (roles, análisis ancho de banda…).

**Roles**

Se han separado los roles en una entidad independiente para evitar duplicación de datos y permitir que varios empleados puedan compartir el mismo rol. 

**Usuarios de Comunicación **

Esta entidad representa a los usuarios que interactúan con el sistema de comunicaciones (llamadas). Se ha decidido separarla de Empleados porque no todos los usuarios son trabajadores, algunos pueden ser externos (clientes). Por eso, para poder diferenciarlos, la tabla dispone del atributo tipo_usuario.

**Llamadas**

Registra toda la actividad telefónica del sistema. Incluye duración, fechas y puntuación. Es necesaria para poder evaluar la calidad del servicio.

**Calidad de Servicios**

Esta entidad almacena la valoración de la calidad audiovisual de cada llamada.

**Análisis de Ancho de Banda**

Aquí se guardan las mediciones de velocidad, latencia y resultados de pruebas de red. Cada análisis lo realiza un empleado y corresponde al equipo de un usuario.

**Avisos**

Esta entidad actúa como registro de auditoría y seguridad del sistema. En esta tabla se guardan los intentos de acceso no autorizados mediante triggers y cualquier incidencia relacionada con el control de acceso.

#### Relaciones establecidas

A partir de los requisitos del sistema se han definido las siguientes relaciones, cada una con su cardinalidad correspondiente: 

| Relación entre entidades | Explicación |
| --- | --- |
| Departamentos – Empleados (1:N) | un departamento puede tener varios empleados, pero cada empleado solo pertenece a uno. |
| Empleados – Roles (N:1) | cada rol puede estar asignado a varios empleados, pero un empleado solo puede tener un rol. |
| Empleados – Análisis de Ancho de Banda (1:N) | un mismo empleado puede realizar muchas pruebas de ancho de banda. |
| Usuarios de Comunicación – Análisis de Ancho de Banda (1:N) | el equipo de un usuario puede ser medido múltiples veces |
| Usuarios de Comunicación – Avisos (1:N)  | se ha creado esta relación para registrar todos los avisos generados por un usuario. |
| Usuarios de Comunicación – Llamadas (1:N)  | un usuario puede realizar y valorar varias llamadas  |
| Llamadas – Calidad de Servicios (N:1) | cada llamada tiene un único registro de calidad. |
| Usuarios de Comunicación – Empleados (0:1)  | se ha definido esta relación como opcional porque un usuario puede estar vinculado a un empleado (si es interno) o no (si es externo).  |

### 2. Diseño del modelo relacional

A partir del diagrama E-R, se ha creado una tabla por cada entidad, asignando una clave primaria única y no nula para poder identificar cada registro de esta, y añadiendo las claves foráneas necesarias para representar las relaciones entre entidades, respetando las cardinalidades definidas en el modelo conceptual. 



![Imagen](./imagenes/img_145.png)



Además de las tablas principales del sistema, se han creado tres tablas adicionales que no mantienen relaciones directas con el resto del modelo relacional. Estas tablas son: 



![Imagen](./imagenes/img_146.png)



#### Explicación

La tabla** BACKUPS** se ha creado con el objetivo de registrar toda la información relacionada con las copias de seguridad realizadas sobre la base de datos. 

Se ha definido como una entidad independiente porque su función es puramente documental. Los backups representan acciones externas realizadas sobre el sistema, no datos que formen parte de la operativa diaria de la empresa. Además, los backups han sido automatizados programando un evento, por eso no se ha considerado necesario establecer relaciones con otras tablas.

La tabla **CONFIGURACIÓN_SERVIDOR_LLAMADAS** se ha creado para almacenar parámetros técnicos del servidor de llamadas, como la dirección IP, los puertos utilizados y los protocolos configurados. Esta información pertenece al ámbito de la administración del sistema y no forma parte de los datos operativos que gestionan usuarios, empleados o procesos de comunicación. Por esta razón, se ha decidido no establecer relaciones con otras tablas. 

La tabla **VIDEOS_STREAMING** almacena información sobre los vídeos disponibles en la plataforma. Esta tabla también se ha definido sin relaciones porque su función es informativa y no interviene en los procesos operativos del sistema. Los vídeos no dependen de ningún usuario ni generan acciones dentro del sistema, por lo que no existe ninguna entidad que requiera referenciarlos. 

## 4.2 Implementación de la base de datos 

### 1. Elección del SGBD  

Para la implementación de la base de datos de InnovateTech se ha seleccionado MariaDB como sistema gestor de bases de datos relacional. Esta elección se ha realizado teniendo en cuenta los requisitos del proyecto, como la gestión de usuarios, la automatización de tareas y la integración con la infraestructura desplegada en AWS. 

MariaDB permite gestionar de forma sencilla usuarios, privilegios y asignaciones de permisos mediante sentencias SQL como CREATE USER, GRANT y REVOKE, facilitando la creación de los roles. Además, el proyecto requiere la implementación de múltiples triggers para controlar cuotas de llamadas, bloquear accesos no autorizados y registrar avisos de auditoría según el rol del usuario. MariaDB ofrece soporte completo para triggers BEFORE y AFTER, permitiendo implementar todos estos controles directamente en la base de datos sin necesidad de desarrollar lógica adicional en aplicaciones externas. 

Otro requisito es la realización de copias de seguridad automáticas. MariaDB incorpora soporte para procedimientos almacenados y eventos programados), lo que permite desarrollar un sistema de backups automáticos que genera ficheros mediante SELECT ... INTO OUTFILE.

Respecto a otras alternativas, como PostgreSQL, aunque ofrece funcionalidades muy avanzadas y una gran capacidad de escalabilidad, muchas de estas características exceden las necesidades de este proyecto. El sistema diseñado no requiere operaciones complejas ni funcionalidades avanzadas de análisis, por lo que MariaDB proporciona una solución más sencilla de administrar y suficiente para cubrir todos los requisitos.

Otro factor determinante en la elección de MariaDB ha sido su gran compatibilidad con AWS.  Su instalación y administración en sistemas Linux es sencilla y requiere bajo consumo de recursos, lo que permite ejecutarlo de forma eficiente en instancias EC2 de tamaño reducido, optimizando los costes de infraestructura sin comprometer el rendimiento del sistema.

### 2. Instalación del SGBD y creación  de la BBDD

Se instaló el sistema gestor de bases de datos MariaDB en la instancia EC2.



![Imagen](./imagenes/img_147.png)





![Imagen](./imagenes/img_148.png)



Tras la instalación, se verificó el correcto funcionamiento del servicio y la versión.



![Imagen](./imagenes/img_149.png)





![Imagen](./imagenes/img_150.png)



Se accedió a la consola de administración como usuario root y se creó la base de datos **innovatetech**.



![Imagen](./imagenes/img_151.png)



Se seleccionó la base de datos recién creada y se comenzaron a implementar las tablas definidas en el diseño lógico de la BBDD.



![Imagen](./imagenes/img_152.png)





![Imagen](./imagenes/img_153.png)





![Imagen](./imagenes/img_154.png)





![Imagen](./imagenes/img_155.png)





![Imagen](./imagenes/img_156.png)





![Imagen](./imagenes/img_157.png)





![Imagen](./imagenes/img_158.png)





![Imagen](./imagenes/img_159.png)



Las tablas **Avisos** y **Backups** también fueron creadas durante esta fase inicial de implementación de la estructura de la base de datos. No obstante, en este punto únicamente se definió su estructura (atributos) porque su desarrollo funcional se realizará posteriormente en sus correspondientes  apartados de auditoría y copias de seguridad automáticas.



![Imagen](./imagenes/img_160.png)





![Imagen](./imagenes/img_161.png)



Una vez finalizada la creación de todas las tablas que forman parte de la base de datos, se realizó una comprobación mediante la sentencia SHOW TABLES para verificar que todas las entidades habían sido creadas correctamente.

Como puede observarse en la captura, la base de datos contiene todas las tablas creadas correctamente. 



![Imagen](./imagenes/img_162.png)



Seguidamente se procedió a la inserción de datos de prueba en cada una de las tablas. Los registros introducidos fueron generados siguiendo la estructura y los atributos definidos previamente para cada entidad.

Tras cada operación de inserción de datos, se ejecutó una consulta SELECT sobre la tabla correspondiente con el objetivo de verificar que los registros se habían almacenado correctamente.



![Imagen](./imagenes/img_163.png)





![Imagen](./imagenes/img_164.png)





![Imagen](./imagenes/img_165.png)





![Imagen](./imagenes/img_166.png)





![Imagen](./imagenes/img_167.png)





![Imagen](./imagenes/img_168.png)





![Imagen](./imagenes/img_169.png)





![Imagen](./imagenes/img_170.png)





![Imagen](./imagenes/img_171.png)





![Imagen](./imagenes/img_172.png)





![Imagen](./imagenes/img_173.png)





![Imagen](./imagenes/img_174.png)





![Imagen](./imagenes/img_175.png)





![Imagen](./imagenes/img_176.png)





![Imagen](./imagenes/img_177.png)





![Imagen](./imagenes/img_178.png)





![Imagen](./imagenes/img_179.png)





![Imagen](./imagenes/img_180.png)





![Imagen](./imagenes/img_181.png)





![Imagen](./imagenes/img_182.png)





![Imagen](./imagenes/img_183.png)





![Imagen](./imagenes/img_184.png)
...
Se crearon los cuatro roles requeridos: **admin**, **vendes**, **administració** y **treballador**. 



![Imagen](./imagenes/img_185.png)





![Imagen](./imagenes/img_186.png)



A cada uno de ellos se le asignaron los permisos y restricciones especificados en el enunciado, garantizando que cada usuario únicamente pudiera acceder y realizar operaciones sobre las tablas correspondientes a sus funciones dentro de la empresa. 



![Imagen](./imagenes/img_187.png)





![Imagen](./imagenes/img_188.png)





![Imagen](./imagenes/img_189.png)





![Imagen](./imagenes/img_190.png)





![Imagen](./imagenes/img_191.png)





![Imagen](./imagenes/img_192.png)





![Imagen](./imagenes/img_193.png)



Mediante la sentencia SHOW GRANTS se verificaron los permisos asignados a cada rol 



![Imagen](./imagenes/img_194.png)



### 2. Script para automatizar la creación de usuarios

Se desarrolló un script en Python capaz de crear usuarios de forma automática introduciendo datos mínimos (nombre de usuario y contraseña), asignarles el rol correspondiente y generar un fichero .sql con las sentencias necesarias para poder ser ejecutado en el SGBD. 

Además, el script incorpora validaciones para detectar errores como usuarios ya existentes o roles no válidos, e incluye la asignación de los permisos especiales requeridos para la realización de copias de seguridad. 



![Imagen](./imagenes/img_195.png)



![Imagen](./imagenes/img_196.png)



Se le dio al archivo python permisos de ejecución.



![Imagen](./imagenes/img_197.png)



Se ejecutó el script y se añadieron nuevos usuarios para comprobar su funcionamiento.



![Imagen](./imagenes/img_198.png)



Se mostró el archivo sql generado utilizando la comanda cat para comprobar la creación de sentencias correctas.



![Imagen](./imagenes/img_199.png)



Comprobar que da error al crear usuarios ya existentes o con roles no válidos.



![Imagen](./imagenes/img_200.png)
...
Los triggers de control de cuotas registran automáticamente un aviso en la tabla avisos cuando un usuario supera el límite de minutos mensuales o el número máximo de llamadas diarias establecido. 

**Trigger que controle la cuota de minutos mensuales por usuario:**

**Cuota:** máximo 500 minutos mensuales por usuario.



![Imagen](./imagenes/img_201.png)



**Trigger que controle la cuota de minutos mensuales por usuario:**

**Cuota:** máximo 10 llamadas al día para cada usuario.



![Imagen](./imagenes/img_202.png)



Comprobar que los triggers se han creado correctamente.



![Imagen](./imagenes/img_203.png)



**Prueba de los triggers: **

1. Intentar insertar una llamada de 600 minutos. 



![Imagen](./imagenes/img_204.png)



2. Insertar 11 llamadas en un mismo día, superando el límite establecido.



![Imagen](./imagenes/img_205.png)



### 2. Tabla de avisos y auditoría

Tal y como se indicó anteriormente, la tabla avisos ya había sido creada durante la implementación inicial de la base de datos; en este apartado se desarrollan los triggers encargados de registrar automáticamente los eventos e intentos de acceso no autorizados en dicha tabla. 

**Trigger que, cuando un usuario con rol trabajador o ventas intente modificar tablas restringidas (empleados y roles), registre el intento en la tabla de avisos.**

Para implementar este requisito fue necesario adaptar la solución al funcionamiento de MariaDB. Si un usuario no dispone de permisos sobre una tabla, la operación es bloqueada por el propio SGBD antes de que el trigger pueda ejecutarse, por lo que no sería posible registrar el intento en la tabla avisos.

Para solucionarlo, se concedieron permisos de SELECT, INSERT, UPDATE y DELETE sobre las tablas empleados y roles a los roles ventas y trabajador. 



![Imagen](./imagenes/img_206.png)



A continuación, se implementaron triggers BEFORE INSERT, BEFORE UPDATE y BEFORE DELETE que verifican el rol del usuario antes de realizar la operación. Si el usuario pertenece a uno de estos roles, el trigger registra automáticamente el intento en la tabla avisos y bloqueando la acción mediante una excepción (SIGNAL), lo que impide que la modificación llegue a ejecutarse sobre la tabla.



![Imagen](./imagenes/img_207.png)





![Imagen](./imagenes/img_208.png)





![Imagen](./imagenes/img_209.png)





![Imagen](./imagenes/img_210.png)





![Imagen](./imagenes/img_211.png)





![Imagen](./imagenes/img_212.png)



Comprobar que se han creado los triggers:



![Imagen](./imagenes/img_213.png)



**Trigger que cuando un usuario con rol administración intente acceder o modificar las tablas del sistema de llamadas de clientes, registre el intento en la tabla de avisos.**

Por la misma razón de antes se otorgan permisos al rol administración sobre la tabla de llamadas, el trigger se activará y restringira el acceso.



![Imagen](./imagenes/img_214.png)





![Imagen](./imagenes/img_215.png)





![Imagen](./imagenes/img_216.png)



**Comprobar que se han creado los nuevos triggers:**



![Imagen](./imagenes/img_217.png)



Después de entrar con un usuario que tenía el rol de administración y tratar de modificar la tabla dos veces, se crearon registros dentro de la tabla Avisos, con un error de intento de modificación no autorizado. 



![Imagen](./imagenes/img_218.png)



### 3. Gestión de bloqueo de usuarios

Se creó un trigger que impide realizar o recibir llamadas si uno de los usuarios se encuentra en estado inactivo o bloqueado. 



![Imagen](./imagenes/img_219.png)



**Probar el trigger:**

Primero ver los usuarios que están bloqueados actualmente.



![Imagen](./imagenes/img_220.png)



Intentar insertar un registro de llamada que incluya al usuario Marta.



![Imagen](./imagenes/img_221.png)



Como se puede observar, devuelve un error que avisa que no se puede realizar el registro de llamada porque uno de los usuarios está bloqueado.

## 4.5 Eventos periódicos - Backup

Se ha creado una carpeta donde se guardaran los backups 



![Imagen](./imagenes/img_222.png)



Probar de hacer un backup



![Imagen](./imagenes/img_223.png)



Comprobar que se guarda en la carpeta



![Imagen](./imagenes/img_224.png)



Mostrar el contenido del csv que se ha creado al hacer el backup, como se puede ver los registros de la tabla empleados se han guardado correctamente.



![Imagen](./imagenes/img_225.png)
...
![Imagen](./imagenes/img_226.png)



Para que el evento haga backups diarios primero he creado un procedimiento (PROCEDURE) que genere los csv y que el evento llame a este procedimiento automáticamente.



![Imagen](./imagenes/img_227.png)
...
![Imagen](./imagenes/img_228.png)



Se ha implementado un evento automático diario porque los datos de los empleados, usuarios y registros de llamadas pueden modificarse con frecuencia. La periodicidad diaria permite minimizar la pérdida de información en caso de incidencia, manteniendo al mismo tiempo un consumo de almacenamiento razonable. Las copias se almacenan en la ruta /var/backups/innovatetech/ y cada ejecución queda registrada en la tabla backups para facilitar la auditoría y el seguimiento de las copias realizadas.

Para comprobar que el evento ejecuta el procedimeinto y se hacen los backups de las tablas, he creado un evento temporal que se ejecute al momento.



![Imagen](./imagenes/img_229.png)



Si hacemos un SELECT de la tabla Backups, se puede comprobar que se han generado los backups.



![Imagen](./imagenes/img_230.png)



También se puede comprobar desde el host que los archivos csv se han guardado en la carpeta indicada.



![Imagen](./imagenes/img_231.png)



## 4.6 Creación de un playbook

Se ha creado una carpeta llamada ansible_innovatetech para guardar el playbook. Este automatiza la instalación de MariaDB, crea la base de datos InnovateTech y sus tablas. Además crea los usuarios y les asigna roles con sus respectivos permisos.



![Imagen](./imagenes/img_232.png)





![Imagen](./imagenes/img_233.png)





![Imagen](./imagenes/img_234.png)





![Imagen](./imagenes/img_235.png)





![Imagen](./imagenes/img_236.png)





![Imagen](./imagenes/img_237.png)





![Imagen](./imagenes/img_238.png)





![Imagen](./imagenes/img_239.png)





![Imagen](./imagenes/img_240.png)





![Imagen](./imagenes/img_241.png)



# 5. Sostenibilidad, Gestión del Cambio y Transformación Digital

## 5.1. Evaluación del Impacto de Seguridad e Importancia de los Datos

### 1. Informe de Evaluación de Riesgos y Seguridad Física/Lógica

La infraestructura de Innovate Tech gestiona datos sensibles como credenciales de empleados en OpenLDAP, registros de auditoría en Elasticsearch/Kibana y contenido multimedia. Un incidente de seguridad en cualquiera de estos activos afecta directamente a la empresa.

**Riesgos Físicos**

| Riesgo | Medida Aplicada |
| --- | --- |
| Acceso no autorizado | MFA (contraseña + RFID + huella), videovigilancia 24/7 |
| Incendio | Sistema Novec 1230, detectores de humo y sensores de temperatura |
| Fallo eléctrico | Dos SAIs APC SRT2200RMXLI en doble conversión online |
| Sobrecalentamiento | CRAC, pasillos fríos/calientes, rango 18-27°C |

**Riesgos Lógicos**

| Riesgo | Medida Aplicada |
| --- | --- |
| Intrusión Externa | Firewall perimetral, ACLs, segmentación entre VMs |
| Acceso no autorizado a servicios | Usuarios nominales por miembro, root deshabilitado, sudo bajo demanda |
| Pérdida de datos | RAID 6 en NAS QNAP, estrategia de backup 3-2-1 |
| Falta de trazabilidad | Auditbeat en todos los servidores, logs centralizados en Elasticsearch/Kibana |

Tras aplicar estas medidas el riesgo se considera aceptable. El eslabón más   sensible sigue siendo el factor humano, por lo que la formación del personal y la revisión periódica de los logs son las acciones más importantes.

### 2. Valor Estratégico de los Datos en la Economía Digital y Normativa Internacional

Los datos de Innovate Tech representan el conocimiento operativo de la empresa. Perderlos o exponerlos tiene consecuencias económicas, reputacionales y legales.

El directorio OpenLDAP centraliza todos los empleados y da acceso al resto de servicios, por lo que su protección es prioritaria. Los registros de Auditbeat permiten reconstruir cualquier incidente y el contenido multimedia del NAS representa producción propia cuya pérdida no es recuperable.

En cuanto a normativa, la infraestructura se alinea con el RGPD: los datos se almacenan en sistemas auditables, el acceso queda registrado por roles y la estrategia 3-2-1 garantiza la integridad de la información. La VPC privada en AWS añade un aislamiento adicional que refuerza este cumplimiento.

## 5.2. Optimización Tecnológica y Transformación Digital

### 1. Medidas de Optimización de Recursos e Impacto Ambiental de la Infraestructura

Consolidar los siete servicios en dos servidores físicos mediante virtualización reduce el consumo eléctrico, el espacio en rack y el calor generado. Los Dell PowerEdge R760 superan el 96% de eficiencia energética y el sistema de pasillos fríos y calientes optimiza el rendimiento del CRAC. En AWS, las instancias t3.medium evitan tener recursos sobredimensionados consumiendo energía innecesariamente.

### 2. Análisis de Transformación Digital: Alineación con los Objetivos Corporativos de Innovate Tech

El proyecto moderniza la gestión interna de Innovate Tech en varios frentes: OpenLDAP centraliza altas y bajas de empleados desde un único punto, Jitsi Meet elimina la dependencia de herramientas externas de videoconferencia y el streaming interno evita recurrir a plataformas de terceros. Ansible hace que cualquier despliegue sea reproducible y Kibana da visibilidad total del estado de la infraestructura en tiempo real. El resultado es una base tecnológica sólida, escalable y alineada con los estándares actuales.
...
El problema era que había una incompatibilidad entre auditbeat 9.1.4.

La solución que llevamos a cabo fue actualizar auditbeat a la versión 9.4.1 añadiendo el repositorio oficial 9.x de Elastic como se puede ver en las siguientes capturas y además también activamos reglas de auditd en el archivo de configuración para que pudiera capturar eventos de su y sudo.



![Imagen](./imagenes/img_242.png)





![Imagen](./imagenes/img_243.png)
